              ...
              <div className="bg-card border border-card-edge rounded-2xl p-6 transition-colors duration-300">
                ...
                {imgSrc && (
                  <button
                    ...
                    className="mt-3 flex items-center gap-1.5 bg-red-500/10 hover:bg-red-500 border border-red-500/40 hover:border-red-500 text-red-400 hover:text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition-all duration-200"
                  >
